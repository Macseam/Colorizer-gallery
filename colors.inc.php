 ...
 */
    ...
    function Get_Color()
    {
        if (isset($this->image))
        {
            $PREVIEW_WIDTH = 5; // We have to resize the image, because we only need the most significant colors.
            $PREVIEW_HEIGHT = 5;
            ...
            for ($y=0; $y < $imgHeight; $y++)
            {
                for ($x=0; $x < $imgWidth; $x++)
                {
                    ...
                    $Colors['red']=intval((($Colors['red'])+15)/32)*32; // Round the colors, to reduce their number, to exclude any duplicates
